"""Django settings for HireProof-AI project."""
import os
...
# ---- HireProof-AI custom config ----
HUGGINGFACE_API_KEY = config('HUGGINGFACE_API_KEY', default='')
HUGGINGFACE_RESUME_MODEL = config('HUGGINGFACE_RESUME_MODEL', default='facebook/bart-large-mnli')
HUGGINGFACE_API_URL = f"https://api-inference.huggingface.co/models/{HUGGINGFACE_RESUME_MODEL}"
